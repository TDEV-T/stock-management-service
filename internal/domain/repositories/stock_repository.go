...
type StockRepository interface {
	...
	GetMovements(ctx context.Context, startDate, endDate time.Time, productID *uint, category *string) ([]models.StockMovement, error)
	GetStockSummary(ctx context.Context) ([]models.Stock, error)
}
